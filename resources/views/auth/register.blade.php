                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="register-form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-4 row">
                                <label for="typologies" class="col-md-4 col-form-label text-md-right">Typologies</label>

                                <div class="col-md-6">
                                    @foreach($typologies as $key => $typology)
                                        <div class="form-check">
                                            <input name="typologies[]" class="form-check-input" type="checkbox" value="{{ $typology->id }}" id="typology{{ $key }}">
