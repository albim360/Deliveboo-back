        ...
        <div class="mb-3">
            ...
            <div class="d-flex @error('typologies') is-invalid @enderror flex-wrap gap-3">
                ...
                <div class="form-check">
                    <input name="typologies[]" class="form-check-input" type="checkbox" value="{{ $typology->id }}" id="typology_{{ $typology->id }}" @if(in_array($typology->id, old('typologies', []))) checked @endif>
