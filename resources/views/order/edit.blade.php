...
<div class="container">
  <form action="{{ route('orders.update', $product) }}" method="POST">
    ...
    <div class="mb-3">
      ...
      <input type="number" class="form-control @error('telephone') is-invalid @enderror" id="telephone" name="telephone" value="{{ old('telephone', $product->telephone) }}">
      @error('telephone')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address" value="{{ old('address', $product->address) }}">
        @error('address')
        <div class="invalid-feedback">
          {{ $message }}
        </div>
